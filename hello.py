# -*- coding: utf-8 -*-
"""Copie de Final_Project_Python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-i9Pp_7e77lmo3vAyynfANZVuOtpdik1

# 💎 Application intelligente de gestion des finances personnelles
...
Technologies : Python, Streamlit, Pandas, Plotly, OpenAI

Année académique : 2025 - 2026

# 📌 Contexte et Problématique

La gestion des finances personnelles constitue un enjeu majeur dans la stabilité économique individuelle.
Cependant, de nombreuses personnes ne disposent pas d’outils adaptés permettant :

- Le suivi structuré des revenus
- La catégorisation des dépenses
- L’analyse statistique des comportements financiers
- L’obtention de recommandations personnalisées

Dans ce contexte, nous avons développé une application interactive permettant :
- La centralisation des données financières
- Leur visualisation dynamique
- Une analyse intelligente assistée par Intelligence Artificielle

# 🟦 Objectifs du Projet

- Concevoir une application interactive
- Permettre le suivi des revenus et dépenses
- Offrir une visualisation dynamique
- Fournir des recommandations IA personnalisées
- Et surtout avoir une bonne note 😊

# 🟦 Architecture du Projet

- Interface (Streamlit)
- Stockage temporaire (Session State)
...
#### **SECTION 1** — Configuration et Design
"""
...
# 
# # Importation nécessaire pour accéder aux secrets de Colab
...
# # ===============================
# # Crée deux colonnes pour l'en-tête : une pour le titre et le sous-titre,
# # et une autre pour les informations du développeur.
...
#     # Affiche le sous-titre descriptif de l'application
#     st.markdown('<div class="subtitle">Suivi intelligent de vos finances personnelles avec Intelligence Artificielle</div>', unsafe_allow_html=True)
# 
# with col2:
#     # Affiche les informations du développeur avec des liens LinkedIn et GitHub.
#     st.markdown("""
#     **👤 Had CODJO**
...
# 
# elif page == "📊 Dépenses":
#     st.markdown("### 📊 Gérer les Dépenses")
# 
#     # --- Section pour l'ajout manuel ---
#     col_manual, col_import = st.columns([1, 1]) # Deux colonnes pour le layout
# 
...
# elif page == "📈 Analyse":
# 
#     st.markdown("### 📈 Analyse Financière Complète")
# 
...
# 
#     st.markdown("### 🤖 Conseiller IA Premium")
# 
...
# Configurez votre token ngrok (à faire une seule fois par session)
ngrok.set_auth_token("3ALy1TeqoplvpbkYZlhpZ8h6qQP_4zadEDgiQhouRhx1Sjj1Z")

# Ferme les anciens tunnels
ngrok.kill()

# Ouvre un tunnel sur le port 8501
public_url = ngrok.connect(8501)
print("🌍 URL publique de votre application :", public_url)

# Lance Streamlit en arrière-plan
process = subprocess.Popen(["streamlit", "run", "app.py"])

time.sleep(5)
print("🚀 Le serveur Streamlit est lancé ! Cliquez sur l'URL ci-dessus.")
